        ...
        <section id="next-steps" className="py-20 px-6 lg:px-12 relative">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-2xl text-brand-text-secondary">
                ...
                <div className="space-y-8 mb-12">
                    ...
                    <div className="holographic-panel rounded-xl p-6 lg:p-8">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h3 className="text-2xl font-poppins font-bold text-brand-text-primary mb-3">
                                    We're a Perfect Fit
                                </h3>
                    ...
                    <ul className="space-y-3">
                        {[
                            ...
                            <li key={index} className="flex items-start gap-4">
                                <svg className="w-6 h-6 text-brand-accent flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <span className="text-brand-text-primary text-xl">{item}</span>
                            </li>
                        ))}
                    </ul>
                </div>
