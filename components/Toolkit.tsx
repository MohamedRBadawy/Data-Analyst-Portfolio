                ...
                <div className="min-h-[500px]">
                    {activeTab === 'dashboards' && (
                        <div className="animate-reveal-in">
                            <div className="flex flex-col lg:flex-row gap-8 items-center holographic-panel p-6 sm:p-8 rounded-xl">
                                <div className="lg:w-3/5 w-full">
                                    ...
                                    >
                                        <video 
                                            ...
                                            muted 
                                            playsInline 
                                            className="rounded-lg shadow-2xl w-full h-auto object-cover transition-transform duration-300 group-hover:scale-105"
                                        />
                                        <div className="absolute inset-0 bg-brand-bg/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                            <span className="text-white font-bold font-poppins py-2 px-4 rounded-lg border-2 border-white">
