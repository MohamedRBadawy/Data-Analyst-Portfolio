            ...
            <div className="lg:w-1/2">
                ...
                {study.oneLineResult && (
                    <div className="mb-4 pb-4 border-b border-brand-accent/30">
                        <p className="text-xs uppercase tracking-wider text-brand-accent font-roboto-mono mb-1">Result</p>
                        <p className="text-brand-text-primary font-semibold leading-snug">
                            {study.oneLineResult}
                        </p>
                    </div>
                )}
