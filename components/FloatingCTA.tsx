...
const FloatingCTA: React.FC<FloatingCTAProps> = ({ onClick }) => {
    ...
    return (
        <button
            ...
            className="fixed bottom-8 right-8 z-40 px-6 py-3 bg-brand-cta rounded-full flex items-center gap-2 shadow-lg transform transition-transform duration-300 hover:scale-105 animate-pulse-cta"
