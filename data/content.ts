...
export const caseStudies: CaseStudy[] = [
    ...
    },
    {
        ...
        story: "A major client relationship was at risk. Our global OTP had dipped below the contractually obligated threshold, and we were flying blind, unable to explain why or where the delays were happening. The pressure was on to regain control. I was brought in to build a tool that would provide immediate, transparent, and undeniable data on our performance across every single facility, turning anecdotal complaints into actionable insights.",
        process: [
